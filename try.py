...
##############################################################################################
root = Tk()
root.title("RETAIL STORE Managment System")
...
def showdatabase():
    ...
    root1.title("Retail Store Management Database")
...
label0 = Label(root,text="RETAIL STORE MANAGEMENT SYSTEM ",bg="Black",fg="#F9FAE9",font=("Times", 27),width=39)
